...
import com.sultani.erfan.tourplannerserver.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Package Managment");
    ...
    private void showDialog() {
        ...
        alertdialoge.setTitle("ADD PACK TO CATEGORY");
        alertdialoge.setMessage("AREA NAME OF PACKAGE");
        ...
        alertdialoge.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (newCategory != null){
                    ...
                    Snackbar.make(drawer,"New Category"+" "+newCategory.getName()+" "+"was add",Snackbar.LENGTH_SHORT).show();
                }
    ...
    // the function that upload image to firebase
    ...
    private void loadMenu() {
            ...
            adapter.notifyDataSetChanged();  //refresh the data to load again
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        {
            Intent payment = new Intent(Home.this,OrderStatus.class);
        ...
        {
            Intent intent = new Intent(Home.this,ShowFavoritePackage.class);
            startActivity(intent);
    ...
    //the method is used for update and show
    private void showUpdateDialog(final String key, final Category item) {

        AlertDialog.Builder alertdialoge = new AlertDialog.Builder(Home.this);
        alertdialoge.setTitle("UPDATE CATEGORY");
        alertdialoge.setMessage("AREA OF THE NAME");
    ...
    //the method is used to change the image and update
